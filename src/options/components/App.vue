<template>
  <el-form ref="form" label-width="10px" size="mini" style="width: 1000px">
    <el-form-item label="" v-for="item in engines" :key="item.id" :gutter="20">
      <el-col :span="2">
        <el-tooltip
          class="item"
          effect="dark"
          content="保存后将根据该字段从小到大排序"
          placement="top"
        >
          <el-input
            size="mini"
      ...
      <el-col :span="3">
        <el-tooltip
          class="item"
          effect="dark"
          content="选中后将展示在Popup页面（浏览器右上角点击插件弹出的页面）"
          placement="top"
        >
      ...
      <el-col :span="3">
        <el-tooltip
          class="item"
          effect="dark"
          content="选中后将展示在右键菜单（如果只选中一个，则会出现在右键顶级菜单）"
          placement="top"
        >
      ...
      <el-col :span="3">
        <el-tooltip
          class="item"
          effect="dark"
          content="选中后将支持快捷键在搜索引擎中切换，比如在百度搜索页面，按下快捷键，快速切换为Google搜索"
          placement="top"
        >
          <el-switch
            v-model="item.inShortcuts"
            active-text="快捷切换"
          ></el-switch>
        </el-tooltip>
      </el-col>
      <el-col :span="4" style="padding-right: 10px;">
        <el-input placeholder="网站名称" v-model="item.name"></el-input>
      </el-col>
      <el-col :span="7" style="padding-right: 10px;">
        <el-input placeholder="跳转地址" v-model="item.url"></el-input>
      </el-col>
      <el-col :span="1">
        <el-button
          type="danger"
